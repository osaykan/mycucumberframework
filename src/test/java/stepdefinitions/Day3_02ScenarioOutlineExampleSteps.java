...
public class Day3_02ScenarioOutlineExampleSteps {
    ...
    dataTablePage.newButtaon.click();
    }
    ...
    public void user_enters_last_name() {
      dataTablePage.laststname.sendKeys("Simsek");
    }
  ...
  dataTablePage.createButton.click();
    ...
    public void user_enters_last_name(String string) {
       dataTablePage.laststname.sendKeys(string);
    }
